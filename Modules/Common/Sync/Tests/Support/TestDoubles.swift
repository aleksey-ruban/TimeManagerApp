...
actor SyncRemoteAPIStub: SyncRemoteAPIServiceProtocol {
    ...
    var pushChronometriesHandler: @Sendable ([Domain.Chronometry], SnapshotVersion) async throws -> [SyncPushResultDTO]
    ...
    init(
        ...
        pushChronometriesHandler: @escaping @Sendable ([Domain.Chronometry], SnapshotVersion) async throws -> [SyncPushResultDTO] = { _, _ in [] }
    ) {
